...
public class CharacterController2D : MonoBehaviour {
    ...
    void SetStats()
    {
		playerUI.valeurArgent.text = argent.ToString();
		playerUI.valeurPv.text = life.ToString();
	}
	...
	public void Move(float move, bool jump, bool dash)
	{
		if (canMove) {
			...
			{
				// m_Rigidbody2D.AddForce(new Vector2(transform.localScale.x * m_DashForce, 10f));
